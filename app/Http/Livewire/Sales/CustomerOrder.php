...
class CustomerOrder extends Component
{
    ...
    {
        return view('livewire.sales.customer-order', [
    ...
    public function save()
    {
        ...
        // Validar si el cliente seleccionado existe en la base de datos
        $customer = Customer::find($this->customer->id);
        if (!$customer) {
            $this->addError('customer_not_found', 'El cliente seleccionado no existe en la base de datos.');
            return;
        }
