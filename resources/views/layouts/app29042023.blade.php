...
<div class="bg-blue-50 flex h-screen">
    <aside class="fixed z-50 md:relative">
        ...
        <nav aria-label="Sidebar Navigation" class="peer-checked:w-64 left-0 z-10 flex h-screen w-0 flex-col overflow-hidden bg-gray-700 text-white transition-all md:h-screen md:w-64 lg:w-64">
        ...
        <span class="">
          ...
          <span class="text-xl">rbane</span>
            ...
            <ul class="mt-8 space-y-3 md:mt-20">
                <li class="relative">
                    <a href="{{ route('customers.index') }}" class="focus:bg-slate-600 hover:bg-slate-600 flex w-full space-x-2 rounded-md px-10 py-4 text-gray-300 focus:outline-none">
            <span
            ><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            ><span class="">Dashboard</span>
                ...
                <li class="relative">
                    <a href="{{ route('customers.index') }}" class="focus:bg-slate-600 hover:bg-slate-600 flex w-full space-x-2 rounded-md px-10 py-4 font-semibold focus:outline-none">
            <span
            ><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div class="flex h-full w-full flex-col">
        ...
        <div class="h-full overflow-hidden">
            <main id="dashboard-main" class="h-[calc(100vh-10rem)] overflow-auto">
                {{ $slot }}
            </main>
        </div>
        <!-- /Main -->
